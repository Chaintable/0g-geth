...
func TestEth2NewBlock(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		...
		block, err := engine.ExecutableDataToBlock(*execData, nil, nil, nil, 0)
		if err != nil {
...
func TestBlockToPayloadWithBlobs(t *testing.T) {
	...
	_, err := engine.ExecutableDataToBlock(*envelope.ExecutionPayload, make([]common.Hash, 1), nil, nil, 0)
	if err != nil {
		t.Error(err)
	}
}
